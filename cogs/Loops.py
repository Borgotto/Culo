...
class Loops(commands.Cog):
    ...
    async def nicknames(self):
        extensions = ["ciruzzo","napoli","struzzo","discord","vodkaredbull","sburrino","carry","trimone","fbi","alifana","azz","storto","doblo'","arrosto","cozze","sfiga","polentone","dove","7z","aac","apk","appx","arc","ass","bin","c","xaml","deb","dn","egg","exe","gbp","gbs","gif","gzip","html","jpg","java","jar","oar","osz","pak","php","pyk","py","pyw","rar","sb","tar","uha","viv","zip","iso","img","cad","dwg","gba","std","js","css","psd","ans","asc","doc","docx","log","pdf","xml","xhtml","xps","ico","bmp","jpeg","png","sym","url","os","dos","root","bat","cpp","c#","lua","obj","wav","mpeg","avi","flv","dns","ogg","webm","nds","3ds","cia","cur","bak","raw","borgo","","silkson","HK fag","quinto pantheon","cock"]
